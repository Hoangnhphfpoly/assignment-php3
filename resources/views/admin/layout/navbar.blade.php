                ...
                <div class="dropdown  custom-dropdown-icon">
                    ...
                    <div class="dropdown-menu dropdown-menu-right animated fadeInUp" aria-labelledby="langDropdown">
                        <a class="dropdown-item" data-img-value="de" data-value="German" href="javascript:void(0);"><img
                                src="{{asset("admin_theme/assets/img/de.png")}}" class="flag-width" alt="flag">
                            German</a>
                        <a class="dropdown-item" data-img-value="jp" data-value="Japanese"
                           href="javascript:void(0);"><img src="{{asset("admin_theme/assets/img/jp.png")}}"
                                                           class="flag-width" alt="flag"> Japanese</a>
                        <a class="dropdown-item" data-img-value="fr" data-value="French" href="javascript:void(0);"><img
                                src="{{asset("admin_theme/assets/img/fr.png")}}" class="flag-width" alt="flag">
                            French</a>
                        <a class="dropdown-item" data-img-value="ca" data-value="English"
                           href="javascript:void(0);"><img src="{{asset("admin_theme/assets/img/ca.png")}}"
                ...
                <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="userProfileDropdown">
                    <div class="user-profile-section">
                        <div class="media mx-auto">
                            <img src="{{asset("admin_theme/assets/img/profile-17.jpg")}}" class="img-fluid mr-2"
                                 alt="avatar">
                            <div class="media-body">
