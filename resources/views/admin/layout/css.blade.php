<link rel="icon" type="image/x-icon" href="{{asset("admin_theme/assets/img/favicon.ico")}}"/>
<link href="{{asset("admin_theme/assets/css/loader.css")}}" rel="stylesheet" type="text/css" />
