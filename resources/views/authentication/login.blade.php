                        ...
                        <form class="text-left" method="post" action="{{route("post-login")}}">
                            ...
                            <div class="form">
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="text" class="form-control" placeholder="e.g Hoangnh@gmail.com">
                                    @error('email')
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{route("auth_pass_recovery")}}" class="forgot-pass-link">Forgot Password?</a>
                                    </div>
