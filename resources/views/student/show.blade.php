...
{{--                                    </li>--}}
            ...
            {{--                    <div class="widget-content widget-content-area">--}}
            {{--                        <h3 class="">Bio</h3>--}}
            {{--                        <p>I'm Web Developer from California. I code and design websites worldwide. Mauris varius--}}
            {{--                            tellus vitae tristique sagittis. Sed aliquet, est nec auctor aliquet, orci ex vestibulum--}}
            {{--                            ex, non pharetra lacus erat ac nulla.</p>--}}
            ...
            {{--                            ridiculus mus. Nunc ut velit finibus, scelerisque sapien vitae, pharetra est. Nunc--}}
            {{--                            accumsan ligula vehicula scelerisque vulputate.</p>--}}
